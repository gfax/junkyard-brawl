...
Ava.test('should be playable', (t) => {
  ...
  const guardDog1 = getCard('guard-dog')
  const guardDog2 = getCard('guard-dog')
  player1.hand = player1.hand.concat([guardDog1])
  player2.hand = player2.hand.concat([guardDog2])

  game.play(player1.id, [guardDog1])
  game.pass(player2.id)
  t.is(player2.hp, 6)
  game.play(player2.id, [guardDog2])
